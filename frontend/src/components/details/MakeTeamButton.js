    ...
    render() {
        ...
        if (isMadeTeam) {
            ...
            <div className="mt-4 mh-auto team-profile-img-warp">
                <img className="team-profile-img-small first-img" src={my_profile.image || require("../../images/noPhoto.jpg")} alt=""/>>
                <img className="team-profile-img-small second-img" src={my_profile.image_two || require("../../images/noPhoto.jpg")} alt=""/>>
                <img className="team-profile-img-small third-img" src={my_profile.image_three || require("../../images/noPhoto.jpg")} alt=""/>>
            </div>;
        } else {
            makeTeamButton =
