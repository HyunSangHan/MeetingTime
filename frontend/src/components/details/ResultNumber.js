    ...
    return (
      <div className="number-info-container pt-36 mb--16 flex">
        <div className="w47percent">
          <div className="font-18 font-bold font-notosan">커트라인</div>
          <div className="font-64 font-jua mt--1 mb--2">{cutline}</div>
        </div>
        <div className="w6percent font-20 font-jua mt-6">{judgment}</div>
        <div className="w47percent">
          <div className="font-18 font-bold font-notosan">나의순번</div>
          <div className="font-purple font-64 font-jua mt--1 mb--2">{rank}</div>
        </div>
      </div>
    )
  }
